<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 gap-4">
                <span class="inline-flex items-center rounded-full bg-indigo-100 dark:bg-indigo-900/40 px-3 py-1 text-sm font-medium text-indigo-700 dark:text-indigo-300">
                    {{ __('Credits') }}: {{ Auth::user()->credits ?? 0 }}
                </span>
                ...
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        @if (Auth::user()->is_admin ?? false)
                            <x-dropdown-link :href="route('topups.admin')">
                                {{ __('Manage Top-ups') }}
                            </x-dropdown-link>
                        @endif
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('ai-assistant.index')" :active="request()->routeIs('ai-assistant.*')">
                {{ __('AI Assistant') }}
            </x-responsive-nav-link>
        </div>
