                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                ...
                                                @elseif ($topUp->status === 'rejected')
                                                    <span class="inline-flex items-center rounded-full bg-red-100 dark:bg-red-900/30 px-2.5 py-0.5 text-xs font-medium text-red-800 dark:text-red-200">
                                                        Rejected
                                                    </span>
                                                @else
                    ...
                    @else
                        <div class="text-center py-8">
                            <p class="text-gray-500 dark:text-gray-400 mb-4">No top-up requests yet.</p>
                            <a href="{{ route('topups.create') }}" class="inline-flex items-center rounded-md bg-emerald-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-emerald-500">
